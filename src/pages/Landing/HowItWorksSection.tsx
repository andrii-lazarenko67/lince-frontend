...
const stepMeta = [
  { number: '01', icon: <SettingsSuggestIcon sx={{ fontSize: 28 }} />, color: '#3b82f6', glow: 'rgba(59,130,246,0.3)' },
  { number: '02', icon: <EditNoteIcon sx={{ fontSize: 28 }} />, color: '#10b981', glow: 'rgba(16,185,129,0.3)' },
  { number: '03', icon: <DashboardIcon sx={{ fontSize: 28 }} />, color: '#8b5cf6', glow: 'rgba(139,92,246,0.3)' },
  { number: '04', icon: <AutoAwesomeIcon sx={{ fontSize: 28 }} />, color: '#d946ef', glow: 'rgba(217,70,239,0.3)' },
];
            ...
            >
              <div className="flex flex-col items-center mb-5">
                <div
                  ...
                  style={{
                    color: stepMeta[i].color,
                    background: `${stepMeta[i].color}18`,
                    border: `1.5px solid ${stepMeta[i].color}50`,
                    boxShadow: `0 0 20px ${stepMeta[i].glow}`,
                  }}
                >
                  {stepMeta[i].icon}
                </div>
                ...
                >
                  {t('landing.howItWorks.stepLabel')} {stepMeta[i].number}
                </span>
              </div>
              ...
              <div
                ...
                style={{
                  ...
                  borderColor: `${stepMeta[i].color}25`,
                  borderTopColor: stepMeta[i].color,
                  borderTopWidth: '2px',
                }}
              >
                ...
                <ul className="space-y-2">
                  {step.detail.map((d, j) => (
                    <li key={j} className="flex items-center gap-2 text-slate-300 text-xs">
                      <CheckIcon sx={{ fontSize: 13, flexShrink: 0 }} style={{ color: stepMeta[i].color }} />
                      {d}
                    </li>
                  ))}
                </ul>
