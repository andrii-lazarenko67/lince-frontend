  ...
  return (
    <View>
      ...
      <View style={styles.infoBox}>
        ...
        {/* Contact Name and Phone on same row */}
        <View style={styles.infoRow}>
          <Text style={styles.infoLabel}>{t('common.contact')}:</Text>
          <Text style={[styles.infoValue, { flex: 0.5 }]}>{data.client.contact || '—'}</Text>
          <Text style={[styles.infoLabel, { width: 80 }]}>{t('common.phone')}:</Text>
          <Text style={[styles.infoValue, { flex: 0.5 }]}>{data.client.phone || '—'}</Text>
        </View>
        ...
        {/* Generated By and Created On on same row */}
        <View style={styles.infoRow}>
          <Text style={styles.infoLabel}>{t('reports.pdf.generatedBy')}:</Text>
          <Text style={[styles.infoValue, { flex: 0.5 }]}>{data.generatedBy.name}</Text>
          <Text style={[styles.infoLabel, { width: 80 }]}>{t('reports.pdf.createdOn')}:</Text>
          <Text style={[styles.infoValue, { flex: 0.5 }]}>{formatDate(data.generatedAt)}</Text>
        </View>
      </View>
    </View>
  );
